...
<div class="page">
    <header>
        <div class="logo"><a href="/events">← Kembali</a></div>
    </header>
    <div class="form-container">
        <h1 class="form-title">Buat Event Baru</h1>
        <form method="POST" action="/events" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="price" class="form-input" min="0" step="1000" value="0">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="requirements" class="form-textarea"></textarea>
            </div>
            <div style="display: flex; gap: 12px;">
                <a href="/events" class="btn-secondary">Batal</a>
